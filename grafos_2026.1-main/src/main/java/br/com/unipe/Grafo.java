...
public class Grafo {
    ...
    public List<String> greedySearch(String nomeVerticeOrigem, String nomeVerticeDestino) {
        ...
        while (!atual.equals(verticeDestino)) {
            ...
            // Otimização: Pegamos direto os vizinhos sem iterar sobre arestas do grafo inteiro
            ...
            // Busca a aresta não percorrida com o menor peso baseada nos vizinhos do vértice atual
    ...
    public static class DadosRota {
        ...
        public DadosRota(List<String> sequenciaNos, int custoTotal) {
    ...
    public DadosRota calcularDijkstra(String pOrigem, String pDestino) {
        ...
        while (!filaPrioridade.isEmpty()) {
            ...
            for (Vertice vizinho : noAtual.getAdjacencias()) {
                ...
                for (int i = 1; i < conexoes.size(); i++) {
                    ...
                    int pesoA = a.getPeso() != null ? a.getPeso() : 1;
                    int pesoMenor = conexaoMaisBarata.getPeso() != null ? conexaoMaisBarata.getPeso() : 1;
                    if (pesoA < pesoMenor) {
                        conexaoMaisBarata = a;
                    }
                }
        ...
        while (rastreador != null) {
            trajetoFinal.add(0, rastreador.getNome());
            rastreador = nosAnteriores.get(rastreador);
        }

        return new DadosRota(trajetoFinal, mapaCustos.get(noFinal));
    }
}